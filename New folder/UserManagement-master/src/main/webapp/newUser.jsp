            ...
            <div class="permission-box">
                ...
                <div class="panel">
                    <table>
                        ...
                        <tr>
                            <td>Dashboard</td>
                            <td><input name="dashboard_add" id="dashboard_add"  type="checkbox" class="check-box" onchange="isCheck('addingCheckBoxes')" ></td>
                            <td><input name="dashboard_delete" id="dashboard_delete" type="checkbox" class="check-box" onchange="isCheck('deleteCheckBoxes')"></td>
                        ...
                        <tr>
                            <td>Settings</td>
                            <td><input name="settings_add" id="settings_add" type="checkbox" class="check-box" onchange="isCheck('addingCheckBoxes')"></td>
