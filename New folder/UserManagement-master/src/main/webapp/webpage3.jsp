...
<body class="body">
<div class="title">
    <div class="title-name">Webpages3</div>
    <div class="sub-title">Permissions granted for webpages 3</div>
</div>
<div class="home">
    <div class="home-icon">
        <a><i class="fa fa-home"></i><span class="color">Home</span>&nbsp;/&nbsp;Webpage 3</a>
    </div>
</div>
